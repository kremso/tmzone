...
describe Tort::Wipo::MarkParser do
  context 'when parsing texual mark' do
    it 'parses mark attributes' do
      ...
      mark.should_receive(:application_date=).with("19.12.2008")
      mark.should_receive(:registration_date=).with("28.05.2009")
      ...
      mark.should_receive(:valid_until=).with("28.05.2019")
  ...
  context 'when parsing visual mark' do
    it 'parses mark attributes' do
      ...
      mark.should_receive(:registration_date=).with("17.03.2009")
      ...
      mark.should_receive(:valid_until=).with("17.03.2019")
