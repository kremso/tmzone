...
describe Indprop do
  ...
  it 'searches indprop for the given term and and page' do
    ...
    Indprop.search("term", 3, downloader, list_parser.as_null_object, mark_fetcher.as_null_object)
  end
  ...
  it 'parses the search results HTML and fills in search results' do
    ...
    results = Indprop.search("term", 1, downloader.as_null_object, list_parser, mark_fetcher)
